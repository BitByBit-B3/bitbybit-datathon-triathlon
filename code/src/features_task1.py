...
from time_utils import extract_time_features

logger = logging.getLogger(__name__)


def extract_task1_features(bookings_df: pd.DataFrame, tasks_df: pd.DataFrame | None = None) -> pd.DataFrame:
    """
...
def extract_test_features_task1(test_inputs_df: pd.DataFrame, tasks_df: pd.DataFrame | None = None) -> pd.DataFrame:
    """
...
def prepare_task1_features_for_training(
